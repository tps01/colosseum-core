...
def write_bench_toml(
    ...
    *,
    ...
    :param raw: Nested config dict (same shape as ``ConfigStore.raw()``).
    :type raw: dict[str, Any]
    :param path: Destination file path.
    :type path: Path | str
    :param header_comment: Optional first-line comment; ``None`` omits the header.
    :type header_comment: str | None, optional

    :returns: Resolved output path.
    :rtype: Path

    :raises TomlWriteError: When the path is invalid or not writable.
    """
