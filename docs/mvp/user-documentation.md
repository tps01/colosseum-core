...
This file tracks user-facing documentation for test engineers and plugin authors. The MVP implementation is complete enough that these are no longer future wave deliverables; the remaining work is polish, API reference completeness, and publication.
